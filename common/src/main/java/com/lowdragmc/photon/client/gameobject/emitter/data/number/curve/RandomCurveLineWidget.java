...
public class RandomCurveLineWidget extends WidgetGroup {
        ...
        if ((selectedPoint0 != -1 && curves0.size() > 1) || (selectedPoint1 != -1 && curves1.size() > 1)) {
            ...
            var widget = new MenuWidget<>(mouseX - getPosition().x, mouseY - getPosition().y, 14, menu.build())
                    .setNodeTexture(new IGuiTexture() {
                        ...
                        public void draw(PoseStack graphics, int mouseX, int mouseY, float x, float y, int width, int height) {
    ...
    @Override
    @Environment(EnvType.CLIENT)
    public void drawInForeground(@NotNull PoseStack graphics, int mouseX, int mouseY, float partialTicks) {
    ...
    @Environment(EnvType.CLIENT)
    protected void renderPoint(Vec2 point, boolean isSelected, @NotNull PoseStack graphics, int mouseX, int mouseY) {
    ...
    @Environment(EnvType.CLIENT)
    protected void renderControlPoint(Vec2 point, @NotNull PoseStack graphics) {
        var position = getPointPosition(point);
