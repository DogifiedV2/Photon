...
public class RandomCurveTexture extends TransformTexture {
    ...
    protected void drawInternal(PoseStack graphics, int mouseX, int mouseY, float x, float y, int width, int height) {
        // render area
    ...
    @Environment(EnvType.CLIENT)
    private void renderLines(PoseStack graphics, ECBCurves curves, float x, float y, int width, int height) {
